...
angular.module('katapi.hyphenateISBN', [])
...
/*
	...
	***** BEGIN LICENSE BLOCK *****
	Copyright Â© 2013 Aurimas Vinckevicius (aurimas.dev~at~gmail.com)
...
.service('ISBN', [function() {
	...
	this.hyphenate = function(isbn) {
		var isbn2 = that.hyphenateInner(isbn);
		if (isbn2 === undefined) {
			console.log('[WARNING] Failed to hyphenate ISBN: "' + isbn + '"');
			return isbn;
		}
		return isbn2;
	};
	...
	this.hyphenateInner = function(isbn) {
